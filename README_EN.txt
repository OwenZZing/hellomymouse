...
When your API credits run out or you've hit your daily limit,
paste paper abstracts directly into Claude Code to generate the same report format manually.
...
Note: Deprecated root-level scripts like generate_report_*.py have been moved to ../legacy_archive/. Do not run them — they drift from the current app.

Comparison:
  Item                    Program (API)        Claude Code manual
  Paper analysis          Full PDF parsing     Abstract-level
  Speed                   3-10 min, auto       Instant after Claude responds
